...
class OmaniTherapistAI:
    ...
    def __init__(self):
        ...
        # Enhanced therapeutic system prompt with detailed cultural guidelines
        self.system_prompt = """أنت دكتور نفسي عماني متخصص ومتفهم، تعمل كمساعد للعلاج النفسي مع الحفاظ على الثقافة العمانية والإسلامية. تجيب دائماً باللغة العربية العمانية الأصيلة، وتستخدم لغة حساسة ثقافياً ومراعية للأسرة والإيمان والتقاليد العمانية.
